...
@section('content')
<form method="POST" action="{{ route(activeGuard().'.cars-types.update',$Model) }}" enctype="multipart/form-data" >
    @csrf
    @method('PUT')
    ...
    <div class="row">
        ...
        <div class="col-md-6 col-sm-12">
            <label>{{ __('trans.people_number') }}</label>
            <input type="number" min="1" name="number" value="{{ $Model['number'] }}" required placeholder="@lang('trans.people_number')" class="form-control">
        </div>
        <div class="col-md-6 col-sm-12">
        ...
        <div class="col-md-6 col-sm-12">
            ...
            <input type="number" min="1" name="price" value="{{ $Model['price'] }}" required placeholder="@lang('trans.price_km')" class="form-control">
        </div>
